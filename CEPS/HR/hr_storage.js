...
const HRStore = {
  KEYS: {
    employees:     'ceps_hr_employees',
    idps:          'ceps_hr_idps',
    feedback:      'ceps_hr_feedback',
    actionLibrary: 'ceps_hr_action_library',
    auditLog:      'ceps_hr_audit_log',
    currentUser:   'ceps_hr_current_user',
    settings:      'ceps_hr_settings',
    initialized:   'ceps_hr_initialized'
  },
