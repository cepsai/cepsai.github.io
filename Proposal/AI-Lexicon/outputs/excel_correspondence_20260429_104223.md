...
_Generated: 2026-04-29T10:42:23_

## Summary

- Analysis records compared: **282** (matched: 240, skipped/no-html: 23, flagged: 115)
...
|  High-risk AI system_ANALYSIS | D4 | model-system | high-risk-ai-system | Definition | ut | An interaction with generative AI that involves the collection of sensitive personal information (health, financial or biometric data) and the provision of personalised recommendations, advice or information that could reasonably be relied… | An interaction with generative AI that involves the collection of sensitive personal information (health, financial or biometric data) or the provision of personalised recommendations, advice or information that could reasonably be relied … |
...
| GPAI_Frontier_Foundation_Analys | C11 | model-system | general-purpose-ai-model | Regulatory trigger | ca | Compute (>10²⁶ operations)  | Compute (≥10²⁶ operations) |
| GPAI_Frontier_Foundation_Analys | D11 | model-system | general-purpose-ai-model | Regulatory trigger | ny | Compute (>10²⁶ operations)  | Compute (≥10²⁶ operations) |
| Risk_ANALYSIS | C4 | risk | systemic-risk | Definition | ca | Foreseeable and material risk of frontier models  (>10²⁶ FLOPs) (§22757.11) | Foreseeable and material risk of frontier models  (≥10²⁶ FLOPs) (§22757.11) |
| Risk_ANALYSIS | D4 | risk | systemic-risk | Definition | ny | Foreseeable and material risk of frontier models  (>10²⁶ FLOPs) (§1420) | Foreseeable and material risk of frontier models  (≥10²⁶ FLOPs) (§1420) |
...
| Modification_ANALYSIS | C6 | modification | substantial-modification | Scope | ca-0-substantially-modified-version-of-a-frontier-model-no-standalone-defined-term | Frontier models (>10²⁶ FLOPs) (§22757.11) | Frontier models (≥10²⁶ FLOPs) (§22757.11) |
...
| Excel sheet | Cell | Concept | Sub-concept | Dim | Juris | Excel value | HTML value |
|---|---|---|---|---|---|---|---|
| GPAI_Frontier_Foundation_Analys | C12 | model-system | general-purpose-ai-model | Exemption | ca | - | When information provided in model outputs is publicly accessible; lawful activity of the federal government; harm in combination with other software where the frontier model did not materially contri |
| Risk_ANALYSIS | B8 | risk | systemic-risk | Exemptions | eu | - | R&D/prototyping exempt from GPAI model definition |
| Deployer_Supplier_Analysis | B46 | deployer-supplier | deployer-of-high-risk-ai-systems | Exemptions | eu | - | R&D/prototyping exempt from GPAI model definition |

### ANALYSIS_MISSING (1)

| Excel sheet | Cell | Concept | Sub-concept | Dim | Juris | Excel value | HTML value |
|---|---|---|---|---|---|---|---|
| Provider_Developer_Analysis | C6 | provider-developer | provider | Provider / developer information | co | Make publicly available statement summarising types of high-risk AI systems provided by developer (§6-1-1702) | - |
...
| Provider_Developer_Analysis | C6 | provider-developer | provider | Provider / developer information | co | §6-1-1702 | (empty) |
